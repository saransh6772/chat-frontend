...
import { DoughnutChart, LineChart } from "../../components/specific/Chart.jsx";
...
const Dashboard = () => {
    ...
    const Appbar = (
        <Paper elevation={3} sx={{ padding: "1rem", margin: "1rem", borderRadius: "1rem" }}>
            ...
            {loading ? (
                ...
                <Container component={"main"}>
                    ...
                    <Stack direction={{ xs: "column", lg: "row", }} flexWrap={"wrap"} justifyContent={"center"} alignItems={{ xs: "center", lg: "stretch", }} sx={{ gap: "2rem" }}>
                        <Paper elevation={3} sx={{ padding: "2rem", borderRadius: "1rem", width: "100%", maxWidth: "40rem", }}>
                            <Typography variant="h4" m={'1rem'}>Last Messages</Typography>
                            <LineChart value={stats?.messagesChart || []} />
                        </Paper>
                        <Paper elevation={3} sx={{ padding: "2rem", borderRadius: "1rem", display: "flex", justifyContent: "center", alignItems: "center", width: { xs: "100%", sm: "50%" }, position: "relative", maxWidth: "25rem", }}>
...
const Widget = ({ title, value, Icon }) => (
    <Paper elevation={3} sx={{ padding: "1rem", margin: "1rem", borderRadius: "1.5rem", width: "20rem", }}>
        <Stack alignItems={"center"} spacing={"1rem"}>
            <Typography sx={{ color: "rgba(0,0,0,0.7)", borderRadius: "50%", border: `5px solid ${matBlack}`, width: "5rem", height: "5rem", display: "flex", justifyContent: "center", alignItems: "center", }}>{value}</Typography>
